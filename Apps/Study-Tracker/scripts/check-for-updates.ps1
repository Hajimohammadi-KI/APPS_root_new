...
$DefaultManifestUrl = "https://raw.githubusercontent.com/Hajimohammadi-KI/Cross-Repository-Code-Intelligence/main/Study-Tracker/releases/cross-repository-update.json"
