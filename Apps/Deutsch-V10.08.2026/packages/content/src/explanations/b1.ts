...
export const b1Explanations = defineExplanations({
  "Präteritum in Erzählungen": {
    ...
    formation: [
      ...
      "Starke Verben haben eine eigene Stammform ohne -te:",
      "Beispielform: [[ging]].",
      "Beispielform: [[kam]].",
      "Beispielform: [[schrieb]].",
      "Der Plural erhält zusätzlich die Endung -en.",
  ...
  "Relativsätze Dativ": {
    ...
    usage: [
      "Der Dativ folgt auf diese Verben:",
      "Dativverb: [[helfen]].",
      "Dativverb: [[danken]].",
      "Dativverb: [[gefallen]].",
      "Dativverb: [[gehören]].",
  ...
  "Konjunktiv II mit würde": {
    ...
    formation: [
      ...
      "Pronomen ich passt zur Form [[würde]].",
      "Pronomen du passt zur Form [[würdest]].",
      "Pronomen er/sie/es passt zur Form [[würde]].",
      "Pronomen wir passt zur Form [[würden]].",
      "Pronomen ihr passt zur Form [[würdet]].",
      "Pronomen sie/Sie passt zur Form [[würden]].",
      "Der Infinitiv steht danach am Satzende.",
    ...
    specialCases: [
      "Bei sein, haben und Modalverben sind kurze Formen üblicher:",
      "sein wird zu [[wäre]].",
      "haben wird zu [[hätte]].",
      "können wird zu [[könnte]].",
  ...
  "Konjunktiv II von sein/haben/Modalverben": {
    ...
    formation: [
      ...
      "können wird zu [[könnte]].",
      "müssen wird zu [[müsste]].",
      "dürfen wird zu [[dürfte]].",
      "sollen wird zu [[sollte]].",
      "mögen wird zu [[möchte]].",
      "Personalendungen im Konjunktiv II:",
  ...
  "Infinitiv mit zu": {
    ...
    usage: [
      "Ein zu-Infinitiv folgt auf diese Verben:",
      "Verb: [[versuchen]].",
      "Verb: [[planen]] zu tun.",
      "Verb: [[hoffen]] zu tun.",
      "Verb: [[vergessen]].",
