  ...
  return (
    <section aria-labelledby="learning-insights-title" className="space-y-3">
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          <p className="section-kicker">Messbarer Lernfortschritt</p>
          <h2 id="learning-insights-title" className="section-title">
            Deine Lernanalyse
          </h2>
        </div>
        <Badge variant="secondary">Niveau {level}</Badge>
      </div>
      ...
      <div className="grid gap-4 xl:grid-cols-[0.9fr_1.1fr]">
        ...
        <Card className="overflow-hidden border-blue-200/80 bg-gradient-to-br from-white to-sky-50/75 shadow-[0_18px_50px_-30px_rgba(30,64,175,0.45)]">
          <CardHeader>
            ...
            <CardDescription>
              Nur tatsächlich gespeicherte Lernaktivitäten werden dargestellt.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div
              ...
              role="img"
              aria-label="Flächendiagramm der gespeicherten Lernaktivität der letzten sieben Tage"
            >
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart
                  accessibilityLayer
            ...
            {!hasActivity ? (
              <p className="mt-2 rounded-xl border border-blue-200 bg-white/85 p-3 text-sm text-slate-700">
                Noch keine Aktivität gespeichert. Nach der ersten Übung beginnt
                die Kurve mit deinen echten Daten.
              </p>
            ) : null}
          </CardContent>
        </Card>
