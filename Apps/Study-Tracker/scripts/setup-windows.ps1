...
function Write-InstallMetadata([string]$Mode) {
  ...
  $state = [ordered]@{
    ...
    updateManifestUrl = "https://raw.githubusercontent.com/Hajimohammadi-KI/Cross-Repository-Code-Intelligence/main/Study-Tracker/releases/cross-repository-update.json"
  }
...
function Register-UninstallEntry {
  ...
  Set-ItemProperty -Path $UninstallRegistryPath -Name "URLInfoAbout" -Value "https://github.com/Hajimohammadi-KI/Cross-Repository-Code-Intelligence"
...
function Initialize-WslCopy {
  ...
  # Forward slashes sidestep that ambiguity.
