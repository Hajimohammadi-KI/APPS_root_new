...
export const a1Explanations = defineExplanations({
  "Personalpronomen und sein": {
    ...
    formation: [
      ...
      "Pronomen ich passt zur Form [[bin]].",
      "Pronomen du passt zur Form [[bist]].",
      "Pronomen er/sie/es passt zur Form [[ist]].",
      "Pronomen wir passt zur Form [[sind]].",
      "Pronomen ihr passt zur Form [[seid]].",
      "Pronomen sie/Sie passt zur Form [[sind]].",
  ...
  haben: {
    ...
    formation: [
      ...
      "Pronomen ich passt zur Form [[habe]].",
      "Pronomen du passt zur Form [[hast]].",
      "Pronomen er/sie/es passt zur Form [[hat]].",
      "Pronomen wir passt zur Form [[haben]].",
      "Pronomen ihr passt zur Form [[habt]].",
      "Pronomen sie/Sie passt zur Form [[haben]].",
    ...
    usage: [
      ...
      "Beispiel: [[Durst]] haben.",
      "Beispiel: [[Zeit]] haben.",
      "Beispiel: [[Angst]] haben.",
      "Beispiel: [[Glück]] haben.",
      "Beispiel: [[Recht]] haben.",
    ],
    wordOrder: [
  ...
  "Präsens regelmäßiger Verben": {
    ...
    formation: [
      ...
      "Pronomen du passt zur Endung [[-st]].",
      "Pronomen er/sie/es passt zur Endung [[-t]].",
      "Pronomen wir passt zur Endung [[-en]].",
      "Pronomen ihr passt zur Endung [[-t]].",
    ...
    specialCases: [
      "Verben auf [[-s]], [[-ß]], [[-z]] oder [[-x]] haben bei du nur -t statt -st.",
      "Beispiel: du heißt, du tanzt.",
  ...
  "Präsens unregelmäßiger Verben": {
    ...
    formation: [
      ...
      "Infinitivvokal bleibt bei wir, ihr und sie/Sie:",
      "Pronomen wir passt zur Form [[fahren]].",
      "Pronomen ihr passt zur Form [[fahrt]].",
      "Pronomen sie passt zur Form [[fahren]].",
    ],
    usage: [
  ...
  "W-Fragen": {
    ...
    formation: [
      ...
      "Häufige Fragewörter im Deutschen:",
      "Fragewort [[wer]] fragt nach einer Person.",
      "Fragewort [[was]] fragt nach einer Sache.",
      "Fragewort [[wo]] fragt nach dem Ort.",
      "Fragewort [[wohin]] fragt nach dem Ziel.",
      "Fragewort [[woher]] fragt nach der Herkunft.",
      "Fragewort [[wann]] fragt nach der Zeit.",
      "Fragewort [[wie]] fragt nach der Art und Weise.",
      "Fragewort [[warum]] fragt nach dem Grund.",
      "Fragewort [[welcher/welche/welches]] fragt nach einer Auswahl.",
  ...
  Akkusativ: {
    ...
    formation: [
      ...
      "Pronomen er wird zu [[ihn]].",
      "Pronomen sie (Singular) wird zu [[sie]].",
      "Pronomen es bleibt [[es]].",
      "Pronomen wir wird zu [[uns]].",
      "Pronomen ihr wird zu [[euch]].",
      "Pronomen sie/Sie (Plural) bleibt [[sie/Sie]].",
    ],
    usage: [
      "Der Akkusativ folgt auf transitive Verben:",
      "Beispielverb: [[haben]].",
      "Beispielverb: [[brauchen]].",
      "Beispielverb: [[sehen]].",
      "Beispielverb: [[kaufen]].",
      "Beispielverb: [[besuchen]].",
      "Beispielverb: [[fragen]].",
      "Nach es gibt steht immer Akkusativ: Es gibt einen freien Platz.",
      "Feste Akkusativpräpositionen:",
      "Akkusativpräposition [[durch]].",
      "Akkusativpräposition [[für]].",
      "Akkusativpräposition [[gegen]].",
      "Akkusativpräposition [[ohne]].",
      "Akkusativpräposition [[um]].",
    ],
    wordOrder: [
  ...
  Possessivartikel: {
    ...
    formation: [
      "Possessivstämme nach Person:",
      "ich hat den Stamm [[mein-]].",
      "du hat den Stamm [[dein-]].",
      "er/es hat den Stamm [[sein-]].",
      "sie (Singular) hat den Stamm [[ihr-]].",
      "wir hat den Stamm [[unser-]].",
      "ihr hat den Stamm [[euer-]].",
      "sie/Sie (Plural) hat den Stamm [[ihr-/Ihr-]].",
      "Endungen im Nominativ (ein-Muster):",
      "Maskulin: [[mein Bruder]].",
      "Feminin: [[meine Schwester]].",
      "Neutrum: [[mein Kind]].",
  ...
  "nicht und kein": {
    ...
    formation: [
      "Kein wird wie ein dekliniert:",
      "Maskulin: [[kein Mann]].",
      "Feminin: [[keine Frau]].",
      "Neutrum: [[kein Kind]].",
      "Plural: [[keine Kinder]].",
      "Akkusativ Maskulin: [[keinen Mann]].",
  ...
  "Modalverb können": {
    ...
    formation: [
      ...
      "Pronomen ich passt zur Form [[kann]].",
      "Pronomen du passt zur Form [[kannst]].",
      "Pronomen er/sie/es passt zur Form [[kann]].",
      "Pronomen wir passt zur Form [[können]].",
      "Pronomen ihr passt zur Form [[könnt]].",
      "Pronomen sie/Sie passt zur Form [[können]].",
  ...
  "Trennbare Verben": {
    ...
    formation: [
      ...
      "Trennbares Präfix: [[ab-]].",
      "Trennbares Präfix: [[an-]].",
      "Trennbares Präfix: [[auf-]].",
      "Trennbares Präfix: [[aus-]].",
      "Trennbares Präfix: [[ein-]].",
      "Trennbares Präfix: [[mit-]].",
      "Trennbares Präfix: [[vor-]].",
      "Trennbares Präfix: [[weg-]].",
      "Trennbares Präfix: [[zu-]].",
      "Trennbares Präfix: [[zurück-]].",
    ...
    specialCases: [
      "Untrennbare Präfixe werden nicht abgetrennt und sind unbetont:",
      "Untrennbares Präfix: [[be-]].",
      "Untrennbares Präfix: [[emp-]].",
      "Untrennbares Präfix: [[ent-]].",
      "Untrennbares Präfix: [[er-]].",
      "Untrennbares Präfix: [[ge-]].",
      "Untrennbares Präfix: [[miss-]].",
      "Untrennbares Präfix: [[ver-]].",
      "Untrennbares Präfix: [[zer-]].",
