...
**Installed implementation updated on 5 September 2026.** English 27.3.24 and DeutschFlow 20.8.30 now include the shared practice loop, immutable evidence, conservative assessment, draft recovery, recording storage, local review, and complete backup/restore. Both installed apps passed the recorded route and installer checks. The [current implementation record](LANGUAGE-AUTOMATICITY-IMPLEMENTATION-2026-09-05.md) separates delivered behavior from unfinished legacy integration, curriculum review, model qualification and real learner outcomes. The full roadmap remains open.
