...
try{for(language of ["en","de"]){
  ...
  try{
    ...
    row.status="passed";row.evidence={catalogUnits:pack.units.length,resumedDraft:true,interruptedTimingUnknown:true,closedPracticeChecked:true,solutionExposureRetained:true,repairLinkedToOriginal:true,openOutputUnassessed:true,noRecordingNoSpeechCredit:true,concurrentDraftProtected:true,reviewPreservesOriginal:true,reviewDoesNotApproveScope:true,completeBackupExported:true,mobileNoOverflow:true,scriptErrors:errors};
