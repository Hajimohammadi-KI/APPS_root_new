...
function Invoke-Menu {
  ...
  $brandFooter = New-UiLabel "LOKALE INSTALLATION`nVersion2 0.6.0 · Daten bleiben auf diesem PC" 34 510 224 48 8.5 ([System.Drawing.FontStyle]::Regular) ([System.Drawing.Color]::FromArgb(216, 200, 233))
