...
export const b2Explanations = defineExplanations({
  ...
  Nominalisierung: {
    ...
    formation: [
      ...
      "Nominalisierungssuffix [[-ung]], z. B. Entscheidung.",
      "Nominalisierungssuffix [[-heit]].",
      "Nominalisierungssuffix [[-keit]].",
      "Nominalisierungssuffix [[-tion]].",
      "Nominalisierungssuffix [[-ität]], z. B. Möglichkeit.",
  ...
  "N-Deklination": {
    ...
    formation: [
      ...
      "Häufige Gruppen der N-Deklination:",
      "Nomen auf -e, zum Beispiel [[Junge]].",
      "Nomen auf -e, zum Beispiel [[Kunde]].",
      "Nomen auf -e, zum Beispiel [[Kollege]].",
      "Fremdwörter auf die Endung [[-ant]].",
      "Fremdwörter auf die Endung [[-ent]].",
      "Fremdwörter auf die Endung [[-ist]].",
      "Fremdwörter auf die Endung [[-oge]].",
  ...
  "indirekte Rede Grundlagen": {
    ...
    formation: [
      "Konjunktiv I meist vom Infinitivstamm:",
      "sein wird zu er [[sei]].",
      "haben wird zu er [[habe]].",
      "kommen wird zu er [[komme]].",
      "Im Plural oft seien, hätten oder kämen zur Eindeutigkeit.",
  ...
  "Konnektoren und Satzverknüpfung": {
    ...
    formation: [
      "Koordinierende Konnektoren ohne Stellungswechsel:",
      "Koordinierender Konnektor [[und]].",
      "Koordinierender Konnektor [[aber]].",
      "Koordinierender Konnektor [[denn]].",
      "Koordinierender Konnektor [[sondern]].",
      "Koordinierender Konnektor [[oder]].",
      "Subordinierende Konnektoren mit Verb am Ende:",
      "Subordinierender Konnektor [[weil]].",
      "Subordinierender Konnektor [[obwohl]].",
      "Subordinierender Konnektor [[während]].",
      "Subordinierender Konnektor [[damit]].",
      "Subordinierender Konnektor [[falls]].",
      "Konjunktionaladverbien mit Verb-zweit-Stellung:",
      "Konjunktionaladverb [[deshalb]].",
      "Konjunktionaladverb [[trotzdem]].",
      "Konjunktionaladverb [[außerdem]].",
      "Konjunktionaladverb [[danach]].",
    ],
    usage: [
      "Konnektoren verknüpfen nach diesen Beziehungstypen:",
      "Beziehungstyp: [[kausal]].",
      "Beziehungstyp: [[konsekutiv]].",
      "Beziehungstyp: [[konzessiv]].",
      "Beziehungstyp: [[adversativ]].",
      "Beziehungstyp: [[temporal]].",
      "Beziehungstyp: [[konditional]] oder [[final]].",
