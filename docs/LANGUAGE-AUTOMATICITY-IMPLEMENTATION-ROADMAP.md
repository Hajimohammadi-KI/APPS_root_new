...
**Installed implementation updated on 5 September 2026.** English 27.3.27 and DeutschFlow 20.8.33 add persistent review drafts, newer-feedback conflict protection and correct recording association to the shared learning loop. Both installer cycles and installed browser checks pass, and the normal profiles were backed up and preserved. The [current implementation record](LANGUAGE-AUTOMATICITY-REVIEW-RECOVERY-2026-09-05.md) records exact evidence and separates the technical release from unfinished curriculum review, assessment qualification and real learner outcomes. The full roadmap remains open.
