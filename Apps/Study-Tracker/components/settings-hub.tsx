  ...
  return <>
    ...
    <div className="settings-stack">
      ...
      {visible("work") && accordion("planning", "◷", settings.labels.sections.planning, "Lernplan, Zeitraum, Kapazität und Ruhetage", <div className="form-grid">
        ...
        <label><span>Standard-Arbeitsmodus</span><select value={settings.planning.dailyWorkMode} onChange={(event) => update({ planning: { ...settings.planning, dailyWorkMode: event.target.value as WerkzeugSettings["planning"]["dailyWorkMode"] } })}><option value="rescue">12-Minuten-Rettung</option><option value="light">70 Minuten leicht</option><option value="full">8 Stunden Vollzeit</option></select><small>Vier Stunden Forschung + vier Stunden Projekt. Der Modus ändert die Zeitmenge, nicht die Qualitätsanforderungen.</small></label>
