...
export async function GET(request: Request) {
  ...
  // Narrow translation scope: `cloud-platform` would have granted this app full
  // control of the learner's entire Google Cloud account.
  if (requested.has("translate")) scopes.push("https://www.googleapis.com/auth/cloud-translation");
