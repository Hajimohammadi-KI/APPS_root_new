const CACHE='grammar-automaticity-v20-8-unified-full-evaluation-de';
const ASSETS=['./','./index.html','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./offline.html','./assets/dashboard-banner.svg'];
